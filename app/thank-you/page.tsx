    ...
    <>
      ...
      <main className="min-h-screen bg-navy flex items-center justify-center py-24 px-4">
        <div className="max-w-2xl w-full">
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-5 mb-6 text-center">
              ...
              <div className="grid grid-cols-2 gap-3 text-left">
                <div>
                  ...
                  <p className="text-white text-sm font-mono font-semibold break-all">{orderId}</p>
                </div>
                <div>
                  <p className="text-slate-500 text-xs">Payment ID</p>
                  <p className="text-white text-sm font-mono font-semibold break-all">{paymentId}</p>
                </div>
              </div>
            </div>
          ...
          >
            <a
              href={`https://wa.me/919999999999?text=Hi%20Aiclex%20Team!%20I%20just%20submitted%20my%20project%20request.%20Order%20ID%3A%20${orderId}`}
              target="_blank"
